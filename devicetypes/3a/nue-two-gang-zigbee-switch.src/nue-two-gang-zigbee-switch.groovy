...
metadata {
    definition (name: "Nue Two Gang ZigBee Switch", namespace: "3A", author: "Kevin X- 3A Smart Home") {
        capability "Actuator"
     ...
     fingerprint profileId: "0104", inClusters: "0000, 0003, 0004, 0005, 0006", outClusters: "0003, 0006, 0008, 0019, 0406", manufacturer: "Feibit Inc co.", model: "FB56+ZSW1HKJ2.5", deviceJoinName: "Nue ZigBee 2 Gang Switch"   
     fingerprint profileId: "0104", inClusters: "0000, 0003, 0004, 0005, 0006", outClusters: "0003, 0006, 0008, 0019, 0406", manufacturer: "Feibit Inc co.", model: "FB56+ZSW1HKJ1.7", deviceJoinName: "Nue ZigBee 2 Gang Switch"     
...
def parse(String description) {
   ...
   if (description?.startsWith('catchall:')) {
    ...
    log.debug "onoff"
    def refreshCmds = zigbee.readAttribute(0x0006, 0x0000, [destEndpoint: 0x11]) +
    				  zigbee.readAttribute(0x0006, 0x0000, [destEndpoint: 0x10]) //+
